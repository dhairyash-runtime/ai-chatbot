...
const features = [
    {
        ...
        description: 'Our chatbot reads your website structure, understands your services and content, and provides context-based answers to visitor queries automatically.',
        link: '#',
        imagePosition: 'right',
    ...
    },
    {
        ...
        description: 'Upload PDFs, policy documents, FAQs, and product manuals to train the chatbot with your organization-specific knowledge base.',
        link: '#',
        imagePosition: 'left',
    ...
    },
    {
        ...
        description: 'Works with any website through API-based integration. Deploy an embeddable chat widget with custom UI styling in minutes.',
        link: '#',
        imagePosition: 'right',
    ...
    },
    {
        ...
        description: 'Seamlessly transfer conversations to a live agent when needed. Ensure complex queries are handled by your team with full conversation context.',
        link: '#',
        imagePosition: 'left',
    ...
    },
    {
        ...
        description: 'Capture leads through intelligent conversation forms and integrate directly with your CRM system for seamless follow-up and conversion tracking.',
        link: '#',
        imagePosition: 'right',
        imageBg: 'linear-gradient(135deg, #e0f2f4 0%, #fcfce3 100%)',
    ...
    },
    {
        ...
        description: 'Track queries, monitor interaction insights, and measure conversion metrics to continuously improve your chatbot performance.',
        link: '#',
        imagePosition: 'left',
        imageBg: 'linear-gradient(135deg, #fcfce3 0%, #e0f2f4 100%)',
    ...
    },
    {
        ...
        title: 'Real-Time Contextual Responses',
        description: 'AI-powered responses that understand user intent and provide accurate, contextual answers in real-time across any topic on your website.',
        link: '#',
        imagePosition: 'right',
        imageBg: 'linear-gradient(135deg, #d3ebf0 0%, #faf8c8 100%)',
        image: 'https://framerusercontent.com/images/xb6qKKA1vbBV9HsKy7EIF1gN7J4.png',
