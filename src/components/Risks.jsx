...
const cardData = [
    {
        ...
        description: 'Traditional chatbots rely on rigid decision trees and keyword matching, failing to understand context or provide meaningful assistance to users.',
        icon: (
    ...
    },
    {
        ...
        description: 'Most bots cannot read or understand website content, leaving customers without accurate answers about your services, products, or policies.',
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        title: 'No Learning Ability',
        description: 'Without AI-driven training on internal documents, FAQs, and policies, chatbots cannot evolve or provide organization-specific answers.',
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        description: 'Without lead capture, human escalation, or CRM integration, chatbot interactions fail to convert into sales or meaningful customer relationships.',
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="w-full font-['Poppins'] bg-white flex flex-col items-center pt-20 pb-0 md:pt-28 px-5 md:px-10 lg:px-20">
                ...
                <div className="relative w-full flex flex-col items-center pb-16 md:pb-24 overflow-hidden">
                    ...
                    <h2 className="relative text-center font-medium text-[20px] md:text-[40px] leading-[1.25] tracking-[-0.02em] text-[#2D1206] max-w-[280px] md:max-w-3xl">
                        Challenges of Traditional Chatbots Without AI Intelligence
                    </h2>

                    {/* Subtitle */}
                    <p className="relative text-center text-[#4C4C4C] mt-4 md:mt-5 text-[20px] md:text-[20px] leading-[1.6] max-w-[300px] md:max-w-lg">
                        Organizations need contextual, AI-driven
                        <br className="hidden md:block" />
                        conversation support that learns and adapts.
                    </p>
