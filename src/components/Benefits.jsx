...
const SMALL_CARDS = [
    ...
    },
    {
        ...
        description:
            'Optional self-hosted deployment for organizations requiring data sovereignty, compliance, and full control over their AI models and conversation data.',
    ...
    return (
        <section className="relative w-full overflow-hidden font-['Poppins']">
            ...
            <div className="relative z-10 flex flex-col items-center px-4 md:px-10 lg:px-16 pt-14 md:pt-24 pb-0">
                ...
                >
                    Accelerate Growth with<br className="hidden md:block" /> AI-Powered Customer Support
                </h2>
                ...
                >
                    An intelligent AI chatbot platform with scalable architecture for
                    website-aware conversations, custom training, and seamless integration.
                </p>
